...
double antenna_x_V[8], antenna_y_V[8];   // use x as x, y as z to see the depth layout
...
gr_antenna->GetHistogram()->SetMaximum(200);
gr_antenna->GetHistogram()->SetMinimum( 170);
